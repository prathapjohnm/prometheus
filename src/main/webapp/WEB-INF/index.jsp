...
<head>
    ...
    <!-- injector:theme -->
    <link rel="stylesheet" href="static/css/libs/oj/v3.0.0/alta/oj-alta-min.css" type="text/css"/>
    <!-- endinjector -->

    <!-- This contains icon fonts used by the starter template -->
    <link rel="stylesheet" href="static/css/demo-alta-site-min.css" type="text/css"/>
...
<script type="text/javascript" src="static/js/libs/require/require.js"></script>
